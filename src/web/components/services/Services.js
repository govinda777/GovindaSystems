  ...
  return (
    <section className="services py-4" id="services" style={{ 
      ...
      <Container>
        <Row className="mb-3">
          <Col className="text-center">
            ...
            <p className="lead mb-3 text-readable">
              Soluções de Inteligência Artificial personalizadas que transformam seu negócio, 
        ...
        <Row className="gx-4">
          {/* Serviço 1: Atendimento Automatizado */}
            ...
            <div className="service-card p-3 rounded h-100 bg-better-contrast" style={{
              ...
              <div className="mb-2">
                <ul className="list-unstyled mb-0">
                  ...
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>Integração com CRM e base de conhecimento</span>
                  </li>
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
              ...
              <div className="d-flex justify-content-between mt-2">
                <Link href="/services" className="btn btn-outline-info py-1 px-2">
                  Ver Detalhes
                </Link>
                <Link href="/join?service=ai-customer-support" className="btn btn-primary py-1 px-2" style={{ 
                  background: 'linear-gradient(90deg, #2ECAD5, #FF6B6B)',
                  border: 'none'
                }}>
                  Solicitar Orçamento
            ...
            <div className="service-card p-3 rounded h-100 bg-better-contrast" style={{
              ...
              <div className="mb-2">
                <ul className="list-unstyled mb-0">
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>Conteúdo para 30 dias em 1 prompt</span>
                  </li>
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                  ...
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>+50% engajamento, -90% tempo</span>
                  </li>
                </ul>
              </div>
              <div className="d-flex justify-content-between mt-2">
                ...
                <Link href="/join?service=social-media-automation" className="btn btn-primary py-1 px-2" style={{ 
                  background: 'linear-gradient(90deg, #2ECAD5, #FF6B6B)',
                  border: 'none'
                }}>
                  Solicitar Orçamento
          ...
          {/* Serviço 3: Automação de Processos */}
          <Col md={4} className="mb-3">
            <div className="service-card p-3 rounded h-100 bg-better-contrast" style={{
              backdropFilter: 'blur(10px)',
              border: '1px solid rgba(255, 255, 255, 0.1)',
              ...
              <h3 className="h5 fw-bold mb-2" style={{ color: '#FF6B6B' }}>⚙️ Automação de Processos</h3>
              <div className="mb-2">
                <ul className="list-unstyled mb-0">
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                  ...
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>-80% tempo, -25% custos operacionais</span>
                  </li>
                </ul>
              </div>
              <div className="d-flex justify-content-between mt-2">
                ...
                <Link href="/join?service=workflow-automation" className="btn btn-primary py-1 px-2" style={{ 
                  background: 'linear-gradient(90deg, #2ECAD5, #FF6B6B)',
                  border: 'none'
                }}>
                  Solicitar Orçamento
        ...
        <Row>
            ...
            <div className="service-card p-3 rounded h-100 bg-better-contrast" style={{
              ...
              <div className="mb-2">
                <ul className="list-unstyled mb-0">
                  ...
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>+250% tráfego orgânico em 12 meses</span>
                  </li>
                </ul>
              </div>
              <div className="d-flex justify-content-between mt-2">
                ...
                <Link href="/join?service=seo-agent" className="btn btn-primary py-1 px-2" style={{ 
                  background: 'linear-gradient(90deg, #2ECAD5, #FF6B6B)',
                  border: 'none'
                }}>
                  Solicitar Orçamento
          ...
          <Col md={4} className="mb-3">
            <div className="service-card p-3 rounded h-100 bg-better-contrast" style={{
              ...
              <h3 className="h5 fw-bold mb-2" style={{ color: '#FF6B6B' }}>🏛️ DAO Builder Premium</h3>
              <div className="mb-2">
                <ul className="list-unstyled mb-0">
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>Construção completa de DAO + IA</span>
                  </li>
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                  ...
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>NFT, DeFi, Games integrados</span>
                  </li>
                  <li className="mb-1 d-flex align-items-start">
                    <span className="me-1" style={{ color: '#2ECAD5' }}>•</span>
                    <span>Serviço premium personalizado</span>
                  </li>
                </ul>
              </div>
              <div className="d-flex justify-content-between mt-2">
                ...
                <Link href="/join?service=dao-builder" className="btn btn-primary py-1 px-2" style={{ 
                  background: 'linear-gradient(90deg, #2ECAD5, #FF6B6B)',
                  border: 'none'
                }}>
                  Solicitar Orçamento
          ...
          <Col md={4} className="mb-3">
            <div className="service-card p-3 rounded h-100 d-flex align-items-center justify-content-center" style={{
              ...
              <div className="text-center">
                <h4 className="h6 fw-bold mb-2" style={{ color: '#2ECAD5' }}>Precisa de algo específico?</h4>
                <p className="small text-readable mb-3">Desenvolvemos soluções customizadas de IA para seu negócio</p>
