      ...
      <Container>
        <Row className="mb-4">
          <Col className="text-center">
            <h2 className="display-4 fw-bold mb-3">Nossas Soluções</h2>
        ...
        <Row className="gx-5">
          <Col lg={6} className="mb-5">
            <div className="service-card bg-white p-4 rounded shadow-sm h-100">
              <div className="service-icon mb-4 p-3 rounded-circle d-inline-block" style={{ background: 'rgba(108, 92, 231, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6c5ce7" className="bi bi-mortarboard" viewBox="0 0 16 16">
                  <path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917l-7.5-3.5ZM8 8.46 1.758 5.965 8 3.052l6.242 2.913L8 8.46Z"/>
                  <path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466 4.176 9.032Zm-.068 1.873.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46l-3.892-1.556Z"/>
                </svg>
              </div>
              <h3 className="h4 fw-bold mb-3">Govinda Systems School & Consulting</h3>
              <div className="mb-4">
                <h4 className="h6 fw-bold">Treinamentos práticos com AI</h4>
              ...
              <div className="mb-4">
                <h4 className="h6 fw-bold">Treinamentos práticos com Blockchain</h4>
                <ul className="list-unstyled">
                  <li className="mb-2 d-flex align-items-start">
                    <span className="me-2 text-primary">•</span>
              ...
              <div>
                <h4 className="h6 fw-bold">Consultoria em tecnologia</h4>
                <ul className="list-unstyled">
                  <li className="mb-2 d-flex align-items-start">
                    <span className="me-2 text-primary">•</span>
          ...
          <Col lg={6} className="mb-5">
            <div className="service-card bg-white p-4 rounded shadow-sm h-100">
              <div className="service-icon mb-4 p-3 rounded-circle d-inline-block" style={{ background: 'rgba(108, 92, 231, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6c5ce7" className="bi bi-code-slash" viewBox="0 0 16 16">
                  <path d="M10.478 1.647a.5.5 0 1 0-.956-.294l-4 13a.5.5 0 0 0 .956.294l4-13zM4.854 4.146a.5.5 0 0 1 0 .708L1.707 8l3.147 3.146a.5.5 0 0 1-.708.708l-3.5-3.5a.5.5 0 0 1 0-.708l3.5-3.5a.5.5 0 0 1 .708 0zm6.292 0a.5.5 0 0 0 0 .708L14.293 8l-3.147 3.146a.5.5 0 0 0 .708.708l3.5-3.5a.5.5 0 0 0 0-.708l-3.5-3.5a.5.5 0 0 0-.708 0z"/>
                </svg>
              </div>
              <h3 className="h4 fw-bold mb-3">Govinda Systems Farm</h3>
              <div className="mb-4">
                <h4 className="h6 fw-bold">Desenvolvimento de Software</h4>
                <ul className="list-unstyled">
                  <li className="mb-2 d-flex align-items-start">
                    <span className="me-2 text-primary">•</span>
              ...
              <div className="mb-4">
                <h4 className="h6 fw-bold">Desenvolvimento Web3 Comunitário</h4>
                <ul className="list-unstyled">
                  <li className="mb-2 d-flex align-items-start">
                    <span className="me-2 text-primary">•</span>
              ...
              <div>
                <h4 className="h6 fw-bold">Automação e Telemetria com IOT</h4>
                <p className="small">Nosso framework colaborativo proporciona agilidade no registro e gerenciamento de dispositivos IOT para coleta de dados e execução de ações.</p>
                <p className="small text-muted">Utilizamos as tecnologias AWS IOT, Esp8266, MQTT Protocol, Blockchain, Next.js em nosso desenvolvimento colaborativo.</p>
              </div>
            </div>
          </Col>
        </Row>
        ...
        <Row className="mt-4">
          <Col md={4} className="mb-4">
            <div className="service-card bg-white p-4 rounded shadow-sm h-100">
              <div className="service-icon mb-4 p-3 rounded-circle d-inline-block" style={{ background: 'rgba(108, 92, 231, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6c5ce7" className="bi bi-badge-ad" viewBox="0 0 16 16">
                  <path d="m3.7 11 .47-1.542h2.004L6.644 11h1.261L5.901 5.001H4.513L2.5 11h1.2zm1.503-4.852.734 2.426H4.416l.734-2.426h.053zm4.759.128c-1.059 0-1.753.765-1.753 2.043v.695c0 1.279.685 2.043 1.74 2.043.677 0 1.222-.33 1.367-.804h.057V11h1.138V4.685h-1.16v2.36h-.053c-.18-.475-.68-.77-1.336-.77zm.387.923c.58 0 1.002.44 1.002 1.138v.602c0 .76-.396 1.2-.984 1.2-.598 0-.972-.449-.972-1.248v-.453c0-.795.37-1.24.954-1.24z"/>
                  <path d="M14 3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h12zM2 2a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H2z"/>
                </svg>
              </div>
              <h3 className="h5 fw-bold mb-3">Marketing Digital</h3>
              <ul className="list-unstyled">
                <li className="mb-2 d-flex align-items-start">
                  <span className="me-2 text-primary">•</span>
          ...
          <Col md={4} className="mb-4">
            <div className="service-card bg-white p-4 rounded shadow-sm h-100">
              <div className="service-icon mb-4 p-3 rounded-circle d-inline-block" style={{ background: 'rgba(108, 92, 231, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6c5ce7" className="bi bi-shop" viewBox="0 0 16 16">
          ...
          <Col md={4} className="mb-4">
            <div className="service-card bg-white p-4 rounded shadow-sm h-100">
              <div className="service-icon mb-4 p-3 rounded-circle d-inline-block" style={{ background: 'rgba(108, 92, 231, 0.1)' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#6c5ce7" className="bi bi-journal-check" viewBox="0 0 16 16">
              ...
              <h3 className="h5 fw-bold mb-3">Compliance & Jurídico</h3>
              <ul className="list-unstyled">
                <li className="mb-2 d-flex align-items-start">
                  <span className="me-2 text-primary">•</span>
        ...
        <Row className="mt-4">
          <Col className="text-center">
            <div className="bg-primary p-5 rounded text-white shadow">
              ...
              <a href="#contact" className="btn btn-light text-primary fw-bold px-4 py-2">Entre em contato</a>
            </div>
          </Col>
        </Row>
      </Container>
