...
const style = {
  ...
  profileInfo: 'flex-1',
  username: 'text-xl font-semibold mb-2 text-white',
  address: 'text-gray-400 text-sm mb-4',
  memberSince: 'text-gray-400 text-sm',
  statsGrid: 'grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8',
  statCard: 'bg-gray-700 p-4 rounded-lg text-center text-white',
  statValue: 'text-2xl font-bold mb-1 text-white',
  statLabel: 'text-sm text-gray-400',
  contributionsSection: 'mb-12',
  sectionTitle: 'text-xl font-semibold mb-4 border-b border-gray-700 pb-3 text-white',
  contributionsList: 'space-y-4 mt-6',
  contributionCard: 'bg-gray-700 p-4 rounded-lg text-white',
  contributionHeader: 'flex justify-between items-start mb-3',
  contributionTitle: 'font-semibold text-white',
  ...
  badgeCard: 'bg-gray-700 p-4 rounded-lg text-center text-white',
  badgeIcon: 'text-4xl mx-auto mb-2',
  badgeTitle: 'font-semibold mb-1 text-white',
  ...
  tab: 'py-3 px-6 font-medium cursor-pointer text-white',
  activeTab: 'border-b-2 border-blue-500 text-blue-400',
  emptyProfilePrompt: 'text-center py-12 text-white',
