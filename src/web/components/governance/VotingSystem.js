...
const style = {
  ...
  proposalCard: 'bg-gray-700 p-5 rounded-lg border border-gray-600',
  proposalTitle: 'text-xl font-semibold',
  proposalMeta: 'flex flex-wrap gap-4 text-sm text-gray-400 mt-2',
  metaItem: 'flex items-center',
  proposalDescription: 'mt-4 mb-6',
  votingSection: 'mt-6 border-t border-gray-600 pt-4',
  votingTitle: 'font-semibold mb-3',
  votingStats: 'flex flex-wrap gap-4 mb-4',
  statBox: 'bg-gray-800 px-3 py-2 rounded-lg text-sm',
  ...
  filterButton: 'px-3 py-1 rounded-lg text-sm border border-gray-600',
